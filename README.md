...
| `REACT_APP_OUTPOST_LOGIN_URL`    | The URL to where users can sign in to the related outpost install                                         | https://example.com        | Yes, for users to be able to sign in and manage their servicr |
